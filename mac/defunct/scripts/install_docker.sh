...
# DMG_URL='https://download.docker.com/mac/stable/Docker.dmg' # Stable...
#
# https://docs.docker.com/docker-for-mac/release-notes/#docker-community-edition-17120-ce-mac46-2018-01-09-stable
#
#Docker Community Edition 17.09.1-ce-mac42 2017-12-11 (Stable)
#DMG_URL='https://download.docker.com/mac/stable/21090/Docker.dmg'
#
...
install_docker_via_homebrew() {
    ...
    brew_cask_install docker # Installed https://download.docker.com/mac/stable/23011/Docker.dmg as of 2/28/18
