...
function showPreviewMessage(rows) {
    return rows < 100
        ? (rows === 1 || rows === 0) ? formatString(Constants.singleRowLabel, rows) : formatString(Constants.lessOneHundredRowsLabel, rows)
        : formatString(Constants.firstOneHundredRowsLabel);
}
