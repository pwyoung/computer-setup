...
const socketServer_1 = require("../../jupyter/common/comms/socketServer");
...
class JupyterClientAdapter extends events_1.EventEmitter {
    ...
    dispose() {
        ...
        this.ipythonAdapter = utils_1.nullValue();
        this.process = utils_1.nullValue();
        this.socketServer = utils_1.nullValue();
        this.startDef = utils_1.nullValue();
    }
    start(envVariables) {
        if (this.startDef) {
            return this.startDef.promise;
        }
        this.startDef = common_1.createDeferred();
        ...
        this.startSocketServer().then(port => {
            ...
            const testDef = common_1.createDeferred();
    ...
    getAllKernelSpecs() {
        return this.start()
            ...
            Object.keys(specs).forEach(key => {
                ...
                kernelspecs[key].name = kernelspecs[key].name || key;
            });
            return { default: '', kernelspecs };
        });
    }
