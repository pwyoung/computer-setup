...
const socketCallbackHandler_1 = require("../../jupyter/common/comms/socketCallbackHandler");
const commands_1 = require("./commands");
const idDispenser_1 = require("../../jupyter/common/idDispenser");
...
class JupyterSocketClient extends socketCallbackHandler_1.SocketCallbackHandler {
    ...
    releaseId(id) {
        ...
        this.idDispenser.Free(parseInt(id, 10));
    }
    listKernelSpecs() {
    ...
    onShellResult() {
        ...
        try {
            ...
            let parsedMesage = utils.nullValue();
            switch (status) {
                case 'abort':
                case 'aborted':
                case 'error': {
    ...
    onIOPUBMessage() {
        ...
        try {
            ...
            const parsedMesage = helpers_1.Helpers.parseIOMessage(message);
            if (!parsedMesage) {
                return;
            }
            if (this.msgSubject.has(msg_id)) {
