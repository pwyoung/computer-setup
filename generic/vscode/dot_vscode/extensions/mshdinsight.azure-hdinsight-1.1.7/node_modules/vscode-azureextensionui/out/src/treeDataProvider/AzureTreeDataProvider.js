    ...
    promptForRootNode(expectedContextValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._azureAccount.status === 'LoggedIn') {
                picks = this._subscriptionNodes.map((n) => {
                    return {
                        data: n,
            ...
            const result = (yield this._ui.showQuickPick(picks, options)).data;
    ...
    getRootNodes(actionContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._azureAccount.status === 'Initializing' || this._azureAccount.status === 'LoggingIn') {
                ...
                commandLabel = localize_1.localize('noSubscriptionsNode', 'No subscriptions found. Edit filters...');
                ...
                this._subscriptionNodes = this._azureAccount.filters.map((filter) => {
                    if (filter.subscription.id === undefined || filter.subscription.displayName === undefined || filter.subscription.subscriptionId === undefined) {
                        ...
                        if (existingNode) {
                            ...
                            return new SubscriptionNode_1.SubscriptionNode(this, this._ui, this._resourceProvider, filter.subscription.id, filter.session, filter.subscription.displayName, filter.subscription.subscriptionId, this._onNodeCreateEmitter);
                        }
                    }
                });
