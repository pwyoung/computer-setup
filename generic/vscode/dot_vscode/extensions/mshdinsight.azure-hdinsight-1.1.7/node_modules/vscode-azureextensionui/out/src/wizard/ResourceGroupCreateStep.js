    ...
    execute(wizardContext, outputChannel) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!wizardContext.resourceGroup) {
                ...
                outputChannel.appendLine(localize_1.localize('CreatingResourceGroup', 'Creating resource group "{0}" in location "{1}"...', newName, newLocation));
                ...
                outputChannel.appendLine(localize_1.localize('CreatedResourceGroup', 'Successfully created resource group "{0}".', newName));
            }
