...
function callWithTelemetryAndErrorHandling(callbackId, telemetryReporter, outputChannel, callback, extensionContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!context.suppressErrorDisplay && outputChannel) {
                ...
                outputChannel.appendLine(localize_1.localize('outputError', 'Error: {0}', errorData.message));
                let result;
                ...
                if (result === DialogResponses_1.DialogResponses.reportAnIssue) {
                    reportAnIssue_1.reportAnIssue(callbackId, errorData, extensionContext);
                }
            }
