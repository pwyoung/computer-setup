    ...
    execute(wizardContext, outputChannel) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!wizardContext.storageAccount) {
                ...
                outputChannel.appendLine(localize_1.localize('CreatingStorageAccount', 'Creating storage account "{0}" in location "{1}" with sku "{2}"...', newName, newLocation, newSkuName));
                ...
                outputChannel.appendLine(localize_1.localize('CreatedStorageAccount', 'Successfully created storage account "{0}".', newName));
            }
