 ...
 * @enum {string}
 */
export declare type OfferType = 'MS-AZR-0017P' | 'MS-AZR-0148P';
/**
 ...
 * Contains response data for the list operation.
 */
export declare type SubscriptionOperationsListResponse = SubscriptionOperationListResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type SubscriptionFactoryCreateSubscriptionInEnrollmentAccountResponse = SubscriptionCreationResult & SubscriptionFactoryCreateSubscriptionInEnrollmentAccountHeaders & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
