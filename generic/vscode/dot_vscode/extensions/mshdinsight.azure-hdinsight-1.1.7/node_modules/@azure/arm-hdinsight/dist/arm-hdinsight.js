...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ClusterDiskEncryptionParameters = {
    ...
    var UpdateGatewaySettingsParameters = {
    ...
    var Clusters = /** @class */ (function () {
         ...
         * @returns Promise<msRest.RestResponse>
         */
        Clusters.prototype.rotateDiskEncryptionKey = function (resourceGroupName$$1, clusterName$$1, parameters, options) {
            return this.beginRotateDiskEncryptionKey(resourceGroupName$$1, clusterName$$1, parameters, options)
                .then(function (lroPoller) { return lroPoller.pollUntilFinished(); });
        };
        Clusters.prototype.getGatewaySettings = function (resourceGroupName$$1, clusterName$$1, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName$$1,
                clusterName: clusterName$$1,
                options: options
         ...
         * @returns Promise<msRest.RestResponse>
         */
        Clusters.prototype.updateGatewaySettings = function (resourceGroupName$$1, clusterName$$1, parameters, options) {
            return this.beginUpdateGatewaySettings(resourceGroupName$$1, clusterName$$1, parameters, options)
                .then(function (lroPoller) { return lroPoller.pollUntilFinished(); });
        };
        /**
         ...
         * @returns Promise<msRestAzure.LROPoller>
         */
        Clusters.prototype.beginRotateDiskEncryptionKey = function (resourceGroupName$$1, clusterName$$1, parameters, options) {
            return this.client.sendLRORequest({
                resourceGroupName: resourceGroupName$$1,
                clusterName: clusterName$$1,
                parameters: parameters,
         ...
         * @returns Promise<msRestAzure.LROPoller>
         */
        Clusters.prototype.beginUpdateGatewaySettings = function (resourceGroupName$$1, clusterName$$1, parameters, options) {
            return this.client.sendLRORequest({
                resourceGroupName: resourceGroupName$$1,
                clusterName: clusterName$$1,
                parameters: parameters,
    ...
    var beginRotateDiskEncryptionKeyOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign({}, ClusterDiskEncryptionParameters, { required: true })
        },
        responses: {
            200: {},
            202: {},
    ...
    var beginUpdateGatewaySettingsOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign({}, UpdateGatewaySettingsParameters, { required: true })
        },
        responses: {
            200: {},
            202: {},
    ...
    var Configurations = /** @class */ (function () {
        ...
        Configurations.prototype.list = function (resourceGroupName$$1, clusterName$$1, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName$$1,
                clusterName: clusterName$$1,
                options: options
