...
exports.ElasticItem = ElasticItem;
class ElasticMatch {
    constructor(headLine, match) {
        this.HasBody = false;
        this.Selected = false;
    ...
    GetErrorFromMessage(text, message) {
...
ElasticMatch.RegexMatch = /^(GET|POST|DELETE|PUT)\s+([A-Za-z0-9\-\._~:\/#\[\]@!$&'\(\)\*+,;=`?]+)\s*$/gim;
exports.ElasticMatch = ElasticMatch;
//# sourceMappingURL=ElasticMatch.js.map