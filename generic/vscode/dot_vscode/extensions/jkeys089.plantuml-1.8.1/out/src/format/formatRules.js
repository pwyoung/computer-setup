...
let rules = [
    ...
    },
    {
        ...
        blockBeginCaptures: {
            1: formatRuleCompiler_1.FormatType.punctLeftSpace
        },
        blockAgainCaptures: {
            1: formatRuleCompiler_1.FormatType.punctLeftSpace
        },
        blockEndCaptures: {
            0: formatRuleCompiler_1.FormatType.word,
        }
    },
    {
        ...
        blockAgainCaptures: {
            1: formatRuleCompiler_1.FormatType.word,
            2: formatRuleCompiler_1.FormatType.word,
        },
        blockEndCaptures: {
            1: formatRuleCompiler_1.FormatType.word,
            2: formatRuleCompiler_1.FormatType.word,
    ...
    },
    {
        ...
        blockEndCaptures: {
            1: formatRuleCompiler_1.FormatType.word,
            2: formatRuleCompiler_1.FormatType.word,
            3: formatRuleCompiler_1.FormatType.punctLeftSpace
        }
    },
    {
        comment: "block while",
        ...
        blockBeginCaptures: {
            1: formatRuleCompiler_1.FormatType.word,
            2: formatRuleCompiler_1.FormatType.punctLeftSpace
        },
        blockEndCaptures: {
            1: formatRuleCompiler_1.FormatType.word,
            2: formatRuleCompiler_1.FormatType.word
    ...
    },
    {
        ...
        captures: {
            0: formatRuleCompiler_1.FormatType.operater,
        }
    },
    //formats
    {
    ...
    },
    {
        ...
        match: /[:,?;)}]/i,
        captures: {
            0: formatRuleCompiler_1.FormatType.punctRightSpace,
        }
    },
    {
        comment: "punct left",
        match: /[({]/i,
        captures: {
            0: formatRuleCompiler_1.FormatType.punctLeftSpace,
        }
    },
    {
        comment: "connectors",
        match: /@/i,
        captures: {
            0: formatRuleCompiler_1.FormatType.connector,
        }
    },
    {
        comment: "as is: a.b|a.|\\n",
        match: /(\.|\\\w)\s?/i,
        captures: {
            0: formatRuleCompiler_1.FormatType.asIs,
        }
    },
    {
        comment: "variables",
...
exports.formatRules = formatRuleCompiler_1.compile(rules, ruleVariables);
