...
# Goal: put all files in the local dir into subdirs, where
# each subdir is named for the (modification) date of the file.

# Credit https://unix.stackexchange.com/questions/683425/how-to-move-files-into-subdirectories-segregated-by-date
