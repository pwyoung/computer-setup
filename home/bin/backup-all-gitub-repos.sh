...
REPO_DATA_FILE=~/.github-repo-data

# List of github urls to clone
REPO_LIST_FILE=~/.github-repo-list
...
get_repo_data() {
    ...
    curl -s -H "Authorization: token $GITHUB_API_TOKEN" "https://api.github.com/user/repos?page=1&per_page=300" > ${REPO_DATA_FILE}
}
